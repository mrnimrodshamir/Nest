...
export const he: Dictionary = {
  ...
  'forum.tel-aviv-moms.description': 'שאלות מקומיות, מפגשים והמלצות',
  'forum.tel-aviv-dads.title': 'אבות תל אביב',
  'forum.tel-aviv-dads.description': 'אבות משתפים תוכניות, שאלות וטיפים מקומיים',
  ...
  'forum.parental-leave.description': 'חברה בשעות היום, שגרה וחזרה לעבודה',
  'forum.baby-sleep.title': 'שינת תינוקות',
  'forum.baby-sleep.description': 'שנת צהריים, לילות ומה עבד להורים אחרים',
  'forum.starting-solids.title': 'תזונה ומעבר למוצקים',
  'forum.starting-solids.description': 'מזונות ראשונים, אלרגיות ורעיונות לארוחות',
  'forum.things-to-do-tel-aviv.title': 'פעילויות עם ילדים בתל אביב',
  'forum.things-to-do-tel-aviv.description': 'מקומות, אירועים ורעיונות מקומיים',
  'forum.local-recommendations.title': 'המלצות מקומיות',
  'forum.local-recommendations.description': 'מרפאות, חוגים, חנויות ובעלי מקצוע',
  'forum.pregnancy-postpartum.title': 'הריון ואחרי לידה',
  'forum.pregnancy-postpartum.description': 'הריון, לידה והחודשים הראשונים',

...
export const FORUMS: readonly ForumDefinition[] = Object.freeze([
  ...
  { key: 'parental-leave', titleKey: 'forum.parental-leave.title', descriptionKey: 'forum.parental-leave.description', icon: 'house', sortOrder: 50 },
  ...
  { key: 'things-to-do-tel-aviv', titleKey: 'forum.things-to-do-tel-aviv.title', descriptionKey: 'forum.things-to-do-tel-aviv.description', icon: 'map-trifold', sortOrder: 80 },
  { key: 'local-recommendations', titleKey: 'forum.local-recommendations.title', descriptionKey: 'forum.local-recommendations.description', icon: 'star', sortOrder: 90 },

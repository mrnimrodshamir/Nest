...
import { buildDigestSendKey, DIGEST_TYPE_DAILY, DIGEST_TYPE_WEEKLY, DIGEST_TYPE_WEEKEND } from './idempotency.ts';
...
test('a different user, type, or date builds a different key', () => {
  ...
  assert.notEqual(buildDigestSendKey('user-1', DIGEST_TYPE_WEEKEND, '2026-08-20'), base);
